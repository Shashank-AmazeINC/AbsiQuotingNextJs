...
const software = () => {
    ...
    const GetSoftware = async () => {
        const { data } = await axios.get("https://103.12.1.103/AbsiQuotingAPI/Master/GetSoftwareMaster")
        SetSoftware(data)
    ...
    return (
        <div className="container-fluid">
            <div className="row">
                <div className="row mt-3">
                    <div className="col-lg-5">
                        <h2 className="fw-bold">Software Dashboard</h2>
                ...
                <div className="row m-2 p-4 shadow-lg rounded-3">
                    ...
                    <div className="col-lg-2">
                        <button className="btn btn-primary btn-sm">Create Software </button>
                    </div>
                </div>
            </div>
            ...
            <table className='table table-hover mt-4 shadow-lg rounded-4 '>
                ...
                <tbody>
                    {
                        Software.slice(offset, offset + PER_PAGE).map((info) => {
                            return ((
                                <tr>
                                    <td>{info.software}</td>
